...
void TableBuilder::Finish()
{
    ...
    _table_file.write(reinterpret_cast<const char *>(&index_size), sizeof(index_size));
}
...
void TableBuilder::Flush()
{
    ...
    _indexes.push_back(Index(_block_builder.FirstKey(), _offset, _block_builder.Size()));
